    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p>
                ...
                dignissimos reprehenderit ducimus.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1">
            {
              skills.length != 0 ? skills.map((item, index) =>
                <Badge key={index}>{item}</Badge>) : <span>N/A</span>
            }
          </div>
        </div>
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          {
            isResume ? <a target="blank" href="https://www.youtube.com/@FarhanHossan" className=" text-blue-500 hover:underline cursor-pointer">Muskan</a> : <span>N/A</span>
          }
